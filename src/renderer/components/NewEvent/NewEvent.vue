  ...
  <div id="wrapper">
    ...
    <form>
      ...
      <v-flex xs12 sm6>
        ...
        <v-btn light large style="margin: auto; margin-left: 0px" class="purple" v-on:click.native="saveEvent">Save new event</v-btn>
    </v-layout>
    </form>
  </div>
</template>
...
import guid from "guid";
  export default {
    ...
    data() {
      return{
        EventName: null,
        GlobalPerformanceLength: null,
        GlobalTransitTime: null,
        StartDate: null,
        EndDate: null,
        EventID: null,
      ...
      saveEvent (){
        if (this.EventName == null || this.StartDate == null || this.EndDate == null){
          ...
          if (this.GlobalPerformanceLength == ""){
            this.GlobalPerformanceLength = null;
          }
          if (this.GlobalTransitTime == ""){
            this.GlobalTransitTime = null;
          }
