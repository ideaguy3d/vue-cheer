    ...
    <main>
        ...
        <v-card class="grey lighten-4 elevation-0">
            <v-card-text>
                <v-container fluid>
                    <v-flex xs8>
                        <v-text-field name="input-1" label="Room Name" id="testing" v-model="RoomName"></v-text-field>
                    </v-flex>
                    <v-flex xs8>
                        <v-text-field name="input-1" label="Room Location" id="testing" v-model="RoomLocation"></v-text-field>
                    </v-flex>
                    </v-layout>
